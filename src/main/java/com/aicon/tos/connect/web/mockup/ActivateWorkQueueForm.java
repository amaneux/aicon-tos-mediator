 ...
 */
public class ActivateWorkQueueForm {

    private static final Logger LOG = LoggerFactory.getLogger(ActivateWorkQueueForm.class);
    private final AiconTosConnectWQRequestTopicProducer producer;
     ...
     */
    protected ActivateWorkQueueForm(AiconTosConnectWQRequestTopicProducer producer) {
    ...
    public Div getForm() {
        ...
        requestId.setValue("WQ_INDEX_123456");
